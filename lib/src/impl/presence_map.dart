...
class LocalPresenceMap {
  ...
  ///
  /// Unlike PresenceMap, does not perform newness comparison.
  /// Normalizes action to PRESENT (RTP17b).
  void put(PresenceMessage message) {
    _map[message.clientId!] = message.copyWith(action: PresenceAction.present);
  }
