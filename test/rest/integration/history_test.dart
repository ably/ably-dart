...
void main() {
  ...
  group('RSL2b1 - Direction forwards', () {
    test(
        'RSL2b1 - history with direction forwards returns oldest first',
        () async {
  ...
  group('RSL2b2 - Limit', () {
    test(
        'RSL2b2 - publish 10 messages, history with limit 5 returns 5',
        () async {
  ...
  group('RSL2b3 - Time range', () {
    test(
        'RSL2b3 - query with start/end returns only messages in range',
        () async {
  ...
  group('RSL2 - Empty channel history', () {
    test(
      ...
      expect(page.items, isEmpty, reason: 'Fresh channel should have no history');
      expect(
        page.hasNext(),
        isFalse,
