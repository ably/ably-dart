...
void main() {
  ...
  group('RTL24 - errorReason cleared on successful attach', () {
  ...
  group('RTL24 - errorReason cleared on successful detach', () {
    test('errorReason is null after successful detach', () async {
