...
class RestSliver extends HookWidget {
  final ably.RestClient rest;
  late ably.RestChannel channel;

  RestSliver(this.rest, {super.key}) {
            ...
            onChanged: (switchedOn) async {
              ...
              if (switchedOn) {
                await channel.setOptions(
                  ably.RestChannelOptions.withCipherKey(
                    keyFromPassword(
                ...
                await channel.setOptions(const ably.RestChannelOptions());
              }
            },
    ...
    return Column(
      ...
      children: [
        ...
        PaginatedResultViewer<ably.PresenceMessage>(
          ...
          query: () =>
              channel.presence.get(const ably.RestPresenceParams(limit: 10)),
          builder: (context, message, _) => Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
        ...
        PaginatedResultViewer<ably.PresenceMessage>(
          ...
          query: () =>
              channel.presence.history(const ably.RestHistoryParams(limit: 10)),
